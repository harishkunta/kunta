...
/**
 * Provides a repair and maintenance form block.
 *
 * @Block(
 *   id = "verathon_bflex_calculator_repair_and_maintenance_form",
 *   admin_label = @Translation("Repair And Maintenance Form"),
 *   category = @Translation("Verathon")
 * )
 */
class RepairAndMaintenanceFormBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new RepairAndMaintenanceFormBlock instance.
   *
