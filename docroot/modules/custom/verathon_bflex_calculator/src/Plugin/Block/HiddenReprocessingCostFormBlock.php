...
/**
 * Provides a hidden reprocessing cost form block.
 *
 * @Block(
 *   id = "verathon_bflex_calculator_hidden_reprocessing_cost_form",
 *   admin_label = @Translation("Hidden Reprocessing Cost Form"),
 *   category = @Translation("Verathon")
 * )
 */
class HiddenReprocessingCostFormBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new HiddenReprocessingCostFormBlock instance.
   *
